...
const WorkPreferencesSettings: React.FC = () => {
    ...
    <div className="space-y-8">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
        ...
        <div className="space-y-3">
          ...
          <button 
            type="button"
            className="w-full text-left p-4 border border-red-200 dark:border-red-900 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
          >
